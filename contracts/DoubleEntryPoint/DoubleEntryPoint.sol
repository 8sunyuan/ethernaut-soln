...
contract VaultDetectionBot {
    ...
    function handleTransaction(address user, bytes calldata msgData) external {
        // if originalsender is crypto vault and function selector is delegateTransfer
        bytes4 selector = bytes4(abi.encodePacked(msgData[0], msgData[1], msgData[2], msgData[3]));
